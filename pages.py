index = {
    ...
    "options": [
        {"link": "/tsstatus", "text": "check the status of the scoot's canoe teamspeak server"},
        {"link": "/ventstatus", "text": "check the status of the scoot's canoe ventrilo server"},
        {"link": "/cssstatus", "text": "check the status of the scoot's canoe cs:s server"},
...
minecraftstatus = {
    "header": "minecraftstatus",
    "prompts": [
        "you have requested the status of the scoot's canoe minecraft server",
        "how would you like your response to be formatted?"
        ],
    "options": [
        {"link": "/minecraftstatus/json", "text": "json"},
        {"link": "/minecraftstatus/html", "text": "html"},
        {"link": "/", "text": "i just want to go home"},
        ]
    }
